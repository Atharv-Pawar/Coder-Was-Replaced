...
# ----------------------------------------------------------------------------
# Progression / Unlock System (Phase 4)
# ----------------------------------------------------------------------------
PROGRESS_PANEL_HEIGHT = 62  # px — sits between code area and status bar

# XP bar in the progress panel
COLOR_XP_BAR_BG    = (30, 33, 42)
COLOR_XP_BAR_FILL  = (80, 180, 110)
COLOR_XP_BAR_FILL2 = (120, 220, 80)   # color when nearly at next unlock

# Level badge in game HUD
COLOR_LEVEL_BG      = (28, 32, 44)
COLOR_LEVEL_BORDER  = (70, 80, 110)
COLOR_LEVEL_TEXT    = (200, 215, 255)
COLOR_LEVEL_XP_TEXT = (140, 200, 140)

# Unlock panel text colors
COLOR_UNLOCKED_FN   = (100, 215, 140)   # function is available
COLOR_LOCKED_FN     = (90, 95, 110)     # function is locked
COLOR_NEXT_UNLOCK   = (255, 200, 80)    # the next function to unlock
COLOR_UNLOCK_TOAST  = (120, 255, 160)   # toast color for new unlocks
